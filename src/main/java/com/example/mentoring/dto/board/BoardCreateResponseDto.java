...
public class BoardCreateResponseDto {
    ...
    public BoardCreateResponseDto toDto(BoardEntity boardEntity){
        // 저장된 변수를 리턴해주는데, 이때 민감정보는 빼주게 되면 반환되지 않는다.
        return new BoardCreateResponseDto(boardEntity.getTitle() ,boardEntity.getContent(), boardEntity.getWriter());
    }
}
